...
ROOT = Path.cwd()
RUN_DATE = "2026-05-29"
PACKET_ID = "directionality_no_overlay_packet_v2_label_masked_controls"

REPORTS = ROOT / "data" / "open_prototype" / "reports"
OUT_DIR = ROOT / "tmp" / "effective_unicity_directionality_blind_packet_v2"
...
CROP_MANIFEST = REPORTS / "effective_unicity_directionality_blind_packet_v2_crop_manifest.csv"
BLIND_MANIFEST = REPORTS / "effective_unicity_directionality_blind_packet_v2_manifest.csv"
ANSWER_KEY = REPORTS / "effective_unicity_directionality_blind_packet_v2_answer_key.csv"
REVIEW_TEMPLATE = REPORTS / "effective_unicity_directionality_blind_packet_v2_review_template.csv"
SUMMARY_JSON = REPORTS / "effective_unicity_directionality_blind_packet_v2_summary.json"
CONTACT_SHEET = OUT_DIR / "directionality_no_overlay_v2_blind_contact_sheet.png"
...
TARGET_SPECS = [
    ...
    },
    {
        ...
        "role": "primary_target_recut",
        "truth_class": "tier1_directionality_candidate_recut_after_v1_edge_fragments",
        "crop_box_xyxy": (1055, 2085, 2115, 2375),
        "expected_token_count": 7,
        "text": "+407-004-001-740-407-590-235+",
        "source_note": "Tighter M-1310 impression recut after v1 reviewer noted edge fragments and counted 8 against 7.",
    },
    {
        "cisi": "M-1320",
...
def main() -> None:
    ...
    summary = {
        "date": RUN_DATE,
        "packet_id": PACKET_ID,
        "status": "v2_packet_created_not_scored_no_claim_promotion",
        "purpose": (
            "Repair the v1 forger/control design by using label-masked raw-page context crops, at least ten unique real "
            "scoring negatives, and explicit quarantine of target views that already failed token-count recovery."
        ),
        "counts": {
        ...
        "promotion_thresholds": [
            ...
            "Paired target views must have distinct image hashes and identical blind token counts from every reviewer.",
