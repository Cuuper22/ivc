...
Sent to [harappa-project-email] requesting higher-resolution M-1584 A source material, data-row confirmation, transcription/sign-list convention, direction or image convention, complete-single-mark status, and permission/citation terms.
```
