...
This campaign tests the seven Mohenjo-daro no-icon `SEAL:R + 002-861` rows as one contrast set.
...
The next decisive evidence has to be source-layout or source-family independence:
