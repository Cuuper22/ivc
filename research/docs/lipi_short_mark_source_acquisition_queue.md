...
This follows the [Lipi short-mark plate request packet](lipi_short_mark_plate_request_packet.md) and the [Lipi short-mark plate public lead search](lipi_short_mark_plate_public_lead_search.md).
