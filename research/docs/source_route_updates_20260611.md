...
- Next gate: when CISI 3.x is acquired, scan the untraced/private-collection plates for the seven-sign Bull1:J seal; otherwise keep 3335.1 out of strict counts. The prior `yajnadevam@proton.me` provenance request remains the other open branch.
