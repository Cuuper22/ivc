...
```text
gmail:19e5ffec0ca38fc5
Sent to harappa@gmail.com requesting higher-resolution M-685 A/a source material, sign transcription or sign-list convention, direction basis, HR 4244276 bridge data, iconography notes, and permission/citation terms.
```
